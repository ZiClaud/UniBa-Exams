...
#ifndef ASD_EXAM_STRUCTURES_TREELIST_H
#define ASD_EXAM_STRUCTURES_TREELIST_H

#include "../ListVector/ListVector.h"
#include "Tree.h"
...
private:
    struct Record {
        item e;
        bool used;
        ListVector<int> childs;
    };
    typedef ListVector<int>::position position_list;
...
#endif //ASD_EXAM_STRUCTURES_TREELIST_H
